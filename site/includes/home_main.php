<main>
	...
	<div class="home_main__bg--top background--blue">
		<div class="container background--beige">
			<div class="row">
				<div class="embed-responsive embed-responsive-16by9">
					<video class="embed-responsive-item" controls >
						<source src="assets/media/AWAKENING_NEW_ZEALAND.mp4" type='video/mp4; codecs="avc1.42E01E, mp4a.40.2"'></source>
					</video>
				</div>
			</div>
	...
	<div class="row">
		<div class="home_main__bg--bottom background--beige"></div>
	</div>
